...
public class SeleniumTest {
	...
	public void test1() throws InterruptedException {
		...
		driver.findElement(By.xpath("//a[@href=\"/jpetstore/actions/Catalog.action?viewProduct=&productId=RP-SN-01\"]")).click();
		driver.findElement(By.xpath("//a[@href=\"/jpetstore/actions/Cart.action?addItemToCart=&workingItemId=EST-11\"]")).click();
		...
		assertTrue(driver.findElement(By.xpath("//a[@href=\"/jpetstore/actions/Account.action?signonForm=\"]")).isDisplayed());
